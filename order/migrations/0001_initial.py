...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product_management', '0002_alter_product_variant_max_price_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Completed', 'Completed'), ('Cancelled_Admin', 'Cancelled_Admin'), ('Cancelled_User', 'Cancelled_User')], default='New', max_length=20)),
